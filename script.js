...
// 2. WITH ERRORS AT INPUT FIELD USER CAN STILL CLICK THE CHECK BUTTON

//------------------------------------------------------------------

const checkMaxGreater = function (negativeVal = '') {
...
btnSumbit.addEventListener('click', checkInput);
